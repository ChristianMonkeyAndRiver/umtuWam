                ...
                doc: [
                    ...
                    },
                    {
                        webview: [
                            {
                                _attr: {
                                    href: document.exists ? `https://us-central1-umtuwam.cloudfunctions.net/http-getProfileView?id=${document.id}&randomKey=${randomKey}` : `https://umtuwam.web.app/Startup.html?did=${uid}&randomKey=${randomKey}`,
                                    internal: 'true',
                                },
                            },
                        ],
