                ...
                .then(async (json) => {
                    if (json.state != util.PaymentState.Approved) {
                        admin
                            ...
                            .where(util.FunctionsConstants.PaymentId, '==', json.paymentID)
                            .get()
                            .then(async (docs) => {
                            ...
                            if (!docs.docs[0].data().isGift) {
                                if (docs.docs[0].data().productId == util.Products.Boost) {
                                    const promise1 = admin
                                        ...
                                        .doc(docs.docs[0].data().purchaserId)
                                        .update({
                                            points: 10,
                                    ...
                                    const expiresAfterAMonth = new admin.firestore.Timestamp(
                                ...
                                const promise2 = docs.docs[0].ref.update({
                                    expiresAt: expiresAt,
                                ...
                                const promise1 = admin
                                    .firestore()
                                    .collection(util.FunctionsConstants.Users)
                                    .doc(docs.docs[0].data().recipientId)
                                    .update({
                                        hasPaidForChatsAndPhotos: true,
