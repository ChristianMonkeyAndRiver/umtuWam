                            ...
                            item: [
                                {
                                    _attr: {
                                        style: '',
                                        href: isChatAndPhotosSubscriptionValid ? '' : `https://us-central1-umtuwam.cloudfunctions.net/http-paymentsView?id=${uid}&uid=${''}&product=${util.Products.ChatsAndPhotos}&isMine=${true}&amount=30`,
                                        layout: 'relative',
                                    },
                                },
                                {
