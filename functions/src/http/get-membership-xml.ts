                                ...
                                item: [
                                    {
                                        _attr: {
                                            style: '',
                                            href: isChatAndPhotosSubscriptionValid
                                                ? ''
                                                : `https://us-central1-umtuwam.cloudfunctions.net/http-paymentsView?id=${uid}&uid=${''}&product=${
                                                      util.Products.ChatsAndPhotos
                                                  }&isMine=${true}&amount=${util.Prices.ChatsAndPhotos}`,
                                            layout: 'relative',
                                        },
                                    },
                                    {
                                        md: isChatAndPhotosSubscriptionValid
                                            ? 'Chat and Photos subscription is currently active'
                                            : `${util.FunctionsConstants.ChatsAndPhotos}: ${util.FunctionsConstants.ClickToPayChatsAndPhotos}`,
                                    },
                                ],
                            },
                            {
                                item: [
                                    {
                                        _attr: {
                                            style: '',
                                            href: isFeaturedSubscriptionValid
                                                ? ''
                                                : `https://us-central1-umtuwam.cloudfunctions.net/http-paymentsView?id=${uid}&uid=${''}&product=${
                                                      util.Products.Boost
                                                  }&isMine=${true}&amount=${util.Prices.Boost}`,
                                            layout: 'relative',
                                        },
                                    },
                                    {
                                        md: isFeaturedSubscriptionValid
                                            ? 'Boost subscription is currently active'
                                            : `${util.FunctionsConstants.Boost}: ${util.FunctionsConstants.ClickToPayFeatured}`,
                                    },
                                ],
                            },
                            !isVerified
                                      ...
                                      item: [
                                          {
                                              _attr: {
                                                  style: '',
                                                  href: `https://us-central1-umtuwam.cloudfunctions.net/http-paymentsView?id=${uid}&uid=${''}&product=${
                                                      util.Products.Verified
                                                  }&isMine=${true}&amount=${util.Prices.Verified}`,
                                                  layout: 'relative',
                                              },
                                          },
                                          {
